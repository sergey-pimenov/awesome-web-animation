...
exports.default = function () {
	...
	function renderTechnologies() {
		...
		for (var i = 0; i < support.length; i++) {
			technologies += technologyTemplate(support[i].name, support[i].id, (0, _supporting2.default)(support[i], 'desktop'), (0, _supporting2.default)(support[i], 'mobile'), (0, _useful2.default)(support[i].useful));
		}
		return technologies;
	}
	...
	(0, _render2.default)(browserSupport, dynamicContent);
	...
	(0, _setWidth2.default)(browserSupport);
	(0, _setWidth2.default)(aboutVersions);
...
var _supporting = __webpack_require__(11);

var _supporting2 = _interopRequireDefault(_supporting);

var _useful = __webpack_require__(12);
...
exports.default = function (api, platform) {
	var markup = '';
...
exports.default = function (usefulLinks) {
	var useful = '';
...
var _browserSupport = __webpack_require__(3);
	...
	setTimeout(function () {
		...
		switch (currentLocation) {
			...
			case '#browser-support':
				(0, _browserSupport2.default)();
				(0, _selectNavItem2.default)('supportNav');
				break;
